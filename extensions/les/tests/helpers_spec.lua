...
describe("IO utilities", function()
    ...
    describe("fileToTable", function()
        it("should read file lines into table", function()
            ...
            local result = {}
            assert.is_true(fileToTable(testFile, result))
        ...
        it("should report a missing source file", function()
            assert.is_false(fileToTable(testFile .. ".missing", {}))
        end)
    end)
...
describe("File operation helpers", function()
    ...
    describe("ShellCopy", function()
        it("should copy file contents", function()
            ...
            assert.is_true(ShellCopy(srcFile, dstFile))
            local f = io.open(dstFile, "r")
            local content = f:read("*a")
            f:close()
        ...
        it("should report a missing source instead of pretending the copy succeeded", function()
            assert.is_false(ShellCopy(testDir .. "/missing.txt", dstFile))
        end)
    end)
